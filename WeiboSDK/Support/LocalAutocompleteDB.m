...
+ (NSString *)databasePath{
    ...
    NSString * databasePath = [[cachesDirectory stringByAppendingPathComponent:[[NSBundle mainBundle] bundleIdentifier]] stringByAppendingPathComponent:@"AutocompleteDB.sqlite3"];
    return databasePath;
}
